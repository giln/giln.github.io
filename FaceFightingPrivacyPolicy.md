...
"2 player games: Face Fighting" is an entertainement app that uses ARKit and TrueDepth Camera  to animate facial expressions onto 3D models. 

Information collected via TrueDepth API is head position, orientation, and distortion based on the users facial expression.

"2 player games: Face Fighting" does not and will not use your Face Data to personally identify any user of the application.
